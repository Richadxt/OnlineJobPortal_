...
<head>
	...
	<title>Richa Jobs - <?php echo "$jobtitle"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><a target="_blank" href="company.php?ref=<?php echo "$compid"; ?>"><?php $compname=""; echo "$compname"; ?></a></li>
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<div class="meta-div clearfix mb-25">
										...
										<span>at <a target="_blank" href="company.php?ref=<?php echo "$compid"; ?>"><?php $compname=""; echo "$compname"; ?></a> as </span>
										<?php echo "$sta"; ?>
									</div>
								...
								<div class="tab-style-01">
									...
									<ul class="nav" role="tablist">
										<li role="presentation" class="active"><h4><a href="#relatedJob1" role="tab" data-toggle="tab">More jobs from <?php $compname= ""; echo "$compname"; ?></a></h4></li>
									</ul>
															...
															<div class="GridLex-col-6_sm-12_xs-12">
																<div class="job-position">
																	...
																	<div class="content">
																		...
																		<p><?php $compname=""; echo "$compname"; ?></p>
																	</div>
																</div>
															</div>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="mailto:richadixit028@gmail.com">richadixit028@gmail.com</a></p>
