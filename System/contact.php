...
<head>
	...
	<title>Richa Jobs - Contact Us</title>
    ...
    <meta property="og:image:alt" content="Richa Jobs" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Lucknow <br/> Uttar-Pradesh <br/>India</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:richadixit028@gmail.com">richadixit028@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91-9653035488">+91-9653XXXXXX</a>
								</li>
